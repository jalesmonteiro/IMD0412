...
public class GradeModuleParametizedTest {
	...
	public static Collection<Object[]> data() {
		return Arrays.asList(new Object[][] {
			{10.f, 10.f, 10.f, 75, ApprovalStatus.APR},
			{7.0f, 7.0f, 7.1f, 75, ApprovalStatus.APR},
			{7.0f, 7.0f, 7.0f, 75, ApprovalStatus.APR},
			
			{7.0f, 7.0f, 6.9f, 75, ApprovalStatus.APRN},
			{5.0f, 5.0f, 5.1f, 75, ApprovalStatus.APRN},
			...
			{0.0f, 0.0f, 0.0f, 75, ApprovalStatus.REP},
			
			{7.0f, 7.0f, 7.1f, 74, ApprovalStatus.REPF},
			{7.0f, 7.0f, 7.0f, 74, ApprovalStatus.REPF},
			{7.0f, 7.0f, 6.9f, 74, ApprovalStatus.REPF},
			{5.0f, 5.0f, 5.1f, 74, ApprovalStatus.REPF},
			...
			{0.0f, 0.0f, 0.0f, 74, ApprovalStatus.REMF},
		});
	}
